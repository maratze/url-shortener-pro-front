		...
		<div class="relative p-8 md:p-10 z-10 bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-slate-700/50 shadow-xl">
			...
			<form @submit.prevent="handleSubmit" class="space-y-6">
				...
				<div class="flex items-center justify-between mt-4">
					...
					<div>
						<NuxtLink to="/forgot-password" class="text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 font-medium transition-colors duration-200">
							Forgot password?
						</NuxtLink>
					</div>
				</div>
            ...
            Logging in...
				...
				<div class="relative flex items-center justify-center my-6">
					...
					<span class="px-4 text-xs font-medium text-slate-500 dark:text-slate-400 bg-transparent relative z-10">or continue with</span>
					<div class="h-px flex-grow bg-slate-200 dark:bg-slate-700"></div>
				</div>
				...
				<p class="text-center text-sm text-slate-600 dark:text-slate-400 mt-6">
					...
					<NuxtLink to="/register" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 font-medium transition-colors duration-200">
						Create one
					</NuxtLink>
				</p>
			</form>
