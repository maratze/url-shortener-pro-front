<template>
    <div v-if="modelValue" class="fixed inset-0 z-50 flex items-center justify-center">
        <!-- Background overlay -->
        <div class="fixed inset-0 bg-black bg-opacity-60" @click="close"></div>
        ...
        <div class="relative max-w-md w-full bg-white dark:bg-slate-800 rounded-lg shadow-xl z-10 p-6">
            ...
            <div class="mb-6">
                <p class="text-slate-700 dark:text-slate-300 mb-4">
                    Введите проверочный код из вашего приложения-аутентификатора для продолжения.
                </p>
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button
                    ...
                    <span v-if="!loading">Проверить</span>
